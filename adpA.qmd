...
1. Navigate to StrepDB and search for the adpA gene (@fig-adpA1). (Enter "adpA" in the search bar at the top left and click "Search Genes").

![The StrepDB database](0images/adpA1.png){#fig-adpA1}

2. A pop-up should appear ("SCO2792 araC-family transcriptional regulator" - click on that link to be redirected to the page for the *adpA* gene - @fig-adpA2)

![The page for adpA in StrepDB](0images/adpA2.png){#fig-adpA2}
...
Select the entire sequence of the gene (@fig-adpA3) and copy it (either using Ctrl+C or right-click and select "Copy" from the menu).

![The adpA nucleotide sequence from StrepDB](0images/adpA3.png){#fig-adpA3}
...
Under "Choose Search Set", keep the database as "Standard databases (nr etc)" and specify the organism (if you begin typing the name of your species (Streptomyces spectabilis), a menu should automatically appear with suggested search terms. We want to select "Streptomyces spectabilis (taxid:68270)) (@fig-adpA4). 

![Using BLAST to find the adpA homolog in Streptomyces spectabilis](0images/adpA4.png){#fig-adpA4}
...
![BLAST hit results - with the link to the Genbank range for this hit circled in red.](0images/adpA5.png){#fig-adpA5}
...
![The nucleotide sequence for the adpA homolog from Streptomyces spectabilis, with the link to the FASTA-formatted sequence highlighted in red](0images/adpA6.png){#fig-adpA6}

![The FASTA sequence of the Streptomyces spectabilis adpA gene highlighted](0images/adpA7.png){#fig-adpA7}

### Import Sequences into Benchling

1. In Benchling, create a new Project to organise your work. Click the + icon and select "Project" (@fig-adpA8). Give your project an informative name and description (this will help you in the future, especially if you have multiple projects or complex work schemes.)

![Starting a new Benchling project](0images/adpA8.png){#fig-adpA8}

2. In your new project, click the + icon again. This time, add a new DNA/RNA sequence (@fig-adpA9).

![Adding a new DNA/RNA sequence in Benchling](0images/adpA9.png){#fig-adpA9}

Give the molecule an informative name, specify the type (DNA),topology (Linear), and project folder (your new project folder). Paste the sequence you obtained from NCBI into "Bases" and click "Create" (@fig-adpA10).

![Create a DNA/RNA sequence in Benchling](0images/adpA10.png){#fig-adpA10}

3. Now, to check that your sequence is correct, you should perform the following checks: 

  A. Check the translation of this sequence - select the entire sequence, click "Create" > "translation" > "Forward" (@fig-adpA11).

![Adding a translation to your adpA sequence in Benchling](0images/adpA11.png){#fig-adpA11}
...
![The adpA sequence with added translation](0images/adpA12.png){#fig-adpA12}
...
![Importing a DNA/RNA sequence in Benchling](0images/adpA13.png){#fig-adpA13}

Search for pMS17 in the <a href="https://www.addgene.org/">addgene database</a> (@fig-adpA14).

![Searching for pMS17 in the addgene website](0images/adpA14.png){#fig-adpA14}
...
![Searching for pMS17 using its addgene URL](0images/adpA15.png){#fig-adpA15}

This should bring up the correct record for pMS17, click "Import" (@fig-adpA16).

![Importing pMS17 into Benchling](0images/adpA16.png){#fig-adpA16}
...
![The pMS17 multiple cloning site](0images/adpA17.png){#fig-adpA17}
...
![Checking the restriction enzyme cutting patterns in pMS17](0images/adpA18.png){#fig-adpA18}
...
![KpnI restriction sites in the adpA sequence](0images/adpA19.png){#fig-adpA19}
...
![NEB double digest selector results for XbaI and EcoRV](0images/adpA20.png){#fig-adpA20}

### Design primers to amplify adpA with the desired restriction enzyme sites

1. Select the first 20-25 bases of the adpA sequence to create your forward primer (if possible, end on a C or a G nucleotide). Click create > Primer > Forward (@fig-adpA21).

![Creating the adpA forward primer](0images/adpA21.png){#fig-adpA21}

In the primer design window that pops up, use the menu to select EcoRV to look up the cut site (GATATC) (@fig-adpA22)

![Adding the EcoRV cut site to the adpA forward primer](0images/adpA22.png){#fig-adpA22}
...
![Adding an overhang to the adpA forward primer](0images/adpA23.png){#fig-adpA23}
...
![The adpA forward primer](0images/adpA24.png){#fig-adpA24}
...
![Linking the adpA primers to create an in silico PCR product](0images/adpA25.png){#fig-adpA25}
...
![Creating the adpA in silico PCR product](0images/adpA26.png){#fig-adpA26}
...
![Digesting the in silico PCR product with EcoRV and NsiI](0images/adpA27.png){#fig-adpA27}
...
![Products generated from the in silico restriction digest](0images/adpA28.png){#fig-adpA28}

2. Similarly, cut the pMS17 vector with EcoRV and NsiI - this should generate two fragments (a small 13 nt portion of the MCS, which is being cut away, and the larger (5876 nt) part of the vector, which we are cloning into - @fig-adpA29).

![Products from the in silico digest of pMS17 with EcoRV and NsiI](0images/adpA29.png){#fig-adpA29}
...
![Choosing an Assembly Strategy in the Benchling Assembly Wizard](0images/adpA30.png){#fig-adpA30}

![Preview of an untitled assembly in Benchling](0images/adpA31.png){#fig-adpA31}
...
![pMS17 selected as the backbone of the assembly](0images/adpA32.png){#fig-adpA32}

Similarly, select and set your NsiI-EcoRV digested adpA fragment as the insert (@fig-adpA33)

![adpA fragment selected as the insert in the assembly](0images/adpA33.png){#fig-adpA33}
...
![The new pMS17-adpA plasmid map](0images/adpA34.png){#fig-adpA34}